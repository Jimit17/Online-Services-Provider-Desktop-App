 ...
 * @author Lenovo
 */
public class Pest_Control extends javax.swing.JFrame {

    /**
     * Creates new form Pest_Control
     */
    public Pest_Control() {
        initComponents();
    }
public Pest_Control(String n){
            initComponents();
            jLabel4.setText(n);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pest Control");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Preferred Date of Service:");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Preferred time of Service");
...
{ try
    {
      ...
      String query="Insert into Pest values('"+Un+"','"+d+"','"+t+"');";
...
new Services_offered(n).setVisible(true);
        Pest_Control p = new Pest_Control();
        p.setVisible(false);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pest_Control.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pest_Control().setVisible(true);
            }
        });
    }
