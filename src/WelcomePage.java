...
public class WelcomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("    Welcome to Ur Avg ServiceProvider");
...
jTextArea1.append("This Terms of Use agreement was last updated: August 31st 2018. This Terms of Use agreement is effective as of: December 22, 2014.\n" +
"Ur avg ServiceProvider Technologies India Pvt Ltd (“Ur avg ServiceProvider”), primarily operates, controls and manages the Services (as defined below) provided by it from its corporate office at Plot No. 19, Sewa Tower, 5th Floor, Anath Road, near Maruti Udyog, Udyog Vihar Phase IV, Sector 18, Gurugram, Haryana – 122015 (“Gurgaon Corporate Office”).\n" +
"A. Acceptance of Terms\n" +
"PLEASE READ THE TERMS OF USE THOROUGHLY AND CAREFULLY. The terms and conditions set forth below (“Terms of Use”) and the Privacy Policy (as defined below) constitute a legally-binding agreement between Ur avg ServiceProvider operating from its Gurgaon Corporate Office and you. These Terms of Use contain provisions that define your limits, legal rights and obligations with respect to your use of and participation in (i) the Ur avg ServiceProvider website and mobile application, including the classified advertisements, forums, various email functions and Internet links, and all content and Ur avg ServiceProvider services available through the domain and sub-domains of Ur avg ServiceProvider located at www.Ur avg ServiceProvider.com (collectively referred to herein as the “Website”), and (ii) the online transactions between those users of the Website who are offering services (each, a “Service Professional”) and those users of the Website who are obtaining services (each, a “Service User”) through the Website (such services, collectively, the “Services”). The Terms of Use described below incorporate the Privacy Policy and apply to all users of the Website, including users who are also contributors of video content, information, private and public messages, advertisements, and other materials or Services on the Website.\n" +
"The Website is owned and operated by Ur avg ServiceProvider Technologies India Pvt. Ltd.\n" +
...
"Ur avg ServiceProvider reserves the right, in its sole discretion, to change, modify, or otherwise amend the Terms of Use, and any other documents incorporated by reference herein for complying with legal and regulatory framework and for other legitimate business purposes, at any time, and Ur avg ServiceProvider will post the amended Terms of Use at the domain of www.Ur avg ServiceProvider.com/terms. It is your responsibility to review the Terms of Use for any changes and you are encouraged to check the Terms of Use frequently. Your use of the Website following any amendment of the Terms of Use will signify your assent to and acceptance of any revised Terms of Use. If you do not agree to abide by these or any future Terms of Use, please do not use or access the Website\n" +
"2. PRIVACY POLICY\n" +
"Ur avg ServiceProvider has established a Privacy Policy that explains to users how their information is collected and used. The Privacy Policy is referenced above and hereby incorporated into the Terms of Use set forth herein. Your use of this Website is governed by the Privacy Policy.\n" +
"The Privacy Policy is located at: Privacy Policy\n" +
"B. Membership and Accessibility\n" +
"1. LICENSE TO ACCESS\n" +
"Ur avg ServiceProvider hereby grants you a non-exclusive, revocable license to use the Website as set forth in the Terms of Use; provided, however, that (i) you will not copy, distribute, or make derivative works of the Website in any medium without Ur avg ServiceProvider's prior written consent; (ii) you will not alter or modify any part of the Website other than as may be reasonably necessary to use the Website for its intended purposes; and (iii) you will otherwise act in accordance with the terms and conditions of the Terms of Use and in accordance with all applicable laws.\n" +
...
"You need not register with Ur avg ServiceProvider to simply visit and view the Website, but to access and participate in certain features of the Website, you will need to create a password-protected account (“Account”). To create an account, you must submit your name and email address through the account registration page on the Website and create a password. You will also have the ability to provide additional optional information, which is not required to register for an account but may be helpful to Ur avg ServiceProvider in providing you with a more customized experience when using the Website. You may also register for an Account using your existing Facebook account and log-in credentials (your “Third-Party Site Password”).\n" +
"You are solely responsible for safeguarding your Ur avg ServiceProvider password and, if applicable, your Third-Party Site Password (collectively, “Passwords”) at all times and shall keep your Passwords secure at all times. You shall be solely responsible for all activity that occurs on your Account and you shall notify Ur avg ServiceProvider immediately of any breach of security or any unauthorized use of your Account. Similarly, you shall never use another's Account without Ur avg ServiceProvider’s permission. You agree that you will not misrepresent yourself or represent yourself as another user of the Website and/or the Services offered through the Website.\n" +
"You hereby expressly acknowledge and agree that you yourself and not Ur avg ServiceProvider will be liable for your losses, damages etc. (whether direct or indirect) caused by an unauthorized use of your Account. Notwithstanding the foregoing, you may be liable for the losses of Ur avg ServiceProvider or others due to such unauthorized use.\n" +
...
"•	You will not copy or distribute any part of the Website in any medium without Ur avg ServiceProvider's prior written authorization.\n" +
...
"•	You shall not use any automated system, including but not limited to, “robots,” “spiders,” “offline readers,” “scrapers,” etc., to access the Website for any purpose without Ur avg ServiceProvider's prior written approval.\n" +
...
"•	You shall not in any way that transmits more request messages to the Ur avg ServiceProvider servers, or any server of a Ur avg ServiceProvider subsidiary or affiliate, in a given period of time than a human can reasonably produce in the same period by using a conventional online web browser; provided, however, that the operators of public search engines may use spiders or robots to copy materials from the site for the sole purpose of creating publicly available searchable indices of the materials, but not caches or archives of such material. Ur avg ServiceProvider reserves the right to revoke these exceptions either generally or in specific cases.\n" +
"•	You shall not recruit, solicit, or contact in any form Service Professionals or Service Users for employment or contracting for a business not affiliated with Ur avg ServiceProvider without express written permission from Ur avg ServiceProvider.\n" +
"•	You shall not take any action that (i) unreasonably encumbers or, in Ur avg ServiceProvider's sole discretion, may unreasonably encumber the Website's infrastructure; (ii) interferes or attempts to interfere with the proper working of the Website or any third-party participation in the Website; or (iii) bypasses Ur avg ServiceProvider's measures that are used to prevent or restrict access to the Website.\n" +
...
"Your access to, use of, and participation in the Website is subject to the Terms of Use and all applicable Ur avg ServiceProvider regulations, guidelines and additional policies that Ur avg ServiceProvider may set forth from time to time, including without limitation, a copyright policy and any other restrictions or limitations that Ur avg ServiceProvider publishes on the Website (the “Additional Policies”). You hereby agree to comply with the Additional Policies and your obligations thereunder at all times. You hereby acknowledge and agree that if you fail to adhere to any of the terms and conditions of this Agreement or documents referenced herein, including the Account Policies, membership eligibility criteria or Additional Policies, Ur avg ServiceProvider, in its sole discretion, may terminate your Account at any time without prior notice to you as well as initiate appropriate legal proceedings, if necessary.\n" +
"C. Member Conduct\n" +
...
"•	contains falsehoods or misrepresentations that could damage Ur avg ServiceProvider or any third party;\n" +
...
"•	is copyrighted, protected by trade secret or otherwise subject to third-party proprietary rights, including privacy and publicity rights, unless you are the owner of such rights or have permission from the rightful owner to post the material and to grant Ur avg ServiceProvider all of the license rights granted herein;\n" +
...
"•	intends to harm or disrupt another user's computer or would allow others to illegally access software or bypass security on websites or servers, including but not limited, to spamming; impersonates, uses the identity of, or attempts to impersonate a Ur avg ServiceProvider employee, agent, manager, host, another user, or any other person though any means;\n" +
"•	advertises or solicits a business not related to or appropriate for the Website (as determined by Ur avg ServiceProvider in its sole discretion);\n" +
...
"•	distributes or contains viruses or any other technologies that may harm Ur avg ServiceProvider, or the interests or property of Ur avg ServiceProvider users\n" +
...
"•	contains identical content to other open Postings you have already posted; or uses any form of automated device or computer program that enables the submission of Postings without the express written consent of Ur avg ServiceProvider\n" +
...
"3. NO DISCRIMINATION\n" +
"1. Discriminatory Postings. Indian laws prohibit any preference, limitation or discrimination based on race, color, religion, sex, national origin, age, handicap or other protected class. Ur avg ServiceProvider will not knowingly accept any Posting which is in violation of the law. Ur avg ServiceProvider has the right, in its sole discretion and without prior notice to you; to immediately remove any posting that discriminates or is any way in violation of any law.\n" +
...
"•	circumvent or manipulate our fee structure, the billing process, or fees owed to Ur avg ServiceProvider; post false, inaccurate, misleading, defamatory, or libelous content (including personal information about any Website user);\n" +
...
"1. Sanctions for Inappropriate Use of Feedback. If you violate any of the above-referenced rules in connection with leaving Feedback, Ur avg ServiceProvider, in its sole discretion, may take any of the following actions: (i) cancel your Feedback or any of your Postings; (ii) limit your Account privileges; (iii) suspend your Account; and/or (iv) decrease your status earned via the Feedback page.\n" +
"2. Reporting Inappropriate Use of Feedback. You may contact Ur avg ServiceProvider regarding any inappropriate use of Feedback via-email at support@Ur avg ServiceProvider.com.\n" +
"3. Resolving Disputes in Connection with Feedback. In the event of any dispute between users of the Website concerning Feedback, Ur avg ServiceProvider shall be the final arbiter of such dispute. Further, IN THE EVENT OF ANY DISPUTE BETWEEN USERS OF THE WEBSITE CONCERNING FEEDBACK, UR AVG SERVICEPROVIDER HAS THE RIGHT, IN ITS SOLE AND ABSOLUTE DISCRETION, TO REMOVE SUCH FEEDBACK OR TAKE ANY ACTION IT DEEMS REASONABLE WITHOUT INCURRING ANY LIABILITY THEREFROM.\n" +
"The foregoing lists of prohibitions provide examples and are not complete or exclusive. Ur avg ServiceProvider reserves the right to (a) terminate your access to your Account, your ability to post to this Website (or the Services) and (b) refuse, delete or remove, move or edit the content, in whole or in part, of any Postings; with or without cause and with or without notice, for any reason or no reason, or for any action that Ur avg ServiceProvider determines is inappropriate or disruptive to this Website or to any other user of this Website and/or Services. Ur avg ServiceProvider reserves the right to restrict the number of e-mails or other messages that you are allowed to send to other users to a number that Ur avg ServiceProvider deems appropriate in Ur avg ServiceProvider's sole discretion. Ur avg ServiceProvider may report to law enforcement authorities any actions that may be illegal, and any reports it receives of such conduct. When legally required or at Ur avg ServiceProvider's discretion, Ur avg ServiceProvider will cooperate with law enforcement agencies in any investigation of alleged illegal activity on this Website or on the Internet.Ur avg ServiceProvider does not and cannot review every Posting posted to the Website. These prohibitions do not require Ur avg ServiceProvider to monitor, police or remove any Postings or other information submitted by you or any other user.\n" +
...
"2. PROFILES AND OFFERS CANNOT USE TECHNIQUES TO AVOID OR CIRCUMVENT UR AVG SERVICEPROVIDER FEES\n" +
"Subject to any exceptions set forth in these Terms of Use or Additional Policies, if any, Service Professionals shall not: (a) offer a catalog or a link to a third-party website from which Service Users or any Registered User or user of the Website may obtain the Service directly; (b) exceed multiple Posting limits; (c) post a single Service but offer additional identical services in the Service description; (d) charge fees for traveling further than desired to provide the Service; (e) offer the opportunity through Ur avg ServiceProvider to purchase the Service or any other service outside of Ur avg ServiceProvider; (f) use their Profile page or user name to promote services not offered on or through the Website and/or prohibited services.\n" +
"In case we realize that any professional is involved in any of the above activities, Ur avg ServiceProvider holds the sole discretion to blacklist the professional and withhold any outstanding credits or payments to the professional.\n" +
...
"Subject to any exceptions set forth in these Terms of Use or Additional Policies, if any, Service Professionals shall not: (a) solicit Service Users to mail cash or use other payment methods not specifically permitted by Ur avg ServiceProvider as approved payment methods; (b) include links that do not conform to Ur avg ServiceProvider's policies with respect to third-party links; (c) use certain types of HTML and JavaScript in Postings, your Profile page, your Offer page, or your Wants page; (d) promote raffles, prizes, bonuses, games of chance, giveaways, or random drawings; (e) use profanity in any Posting; (f) acknowledge or credit a third-party service professional for services or products directly connected with your particular Posting (1) with more than 10 words of text at HTML font size greater than 3 and/or a logo of 88X33 pixels (provided that you represent and warrant that you have the necessary rights, licenses, permissions and/or authorizations from the applicable third party to use that third party's name and/or logo), (2) with any promotional material in connection with that third-party company, and/or (3) with a link to the third-party's website with any information in addition to the Service provided via Ur avg ServiceProvider; (g) include third-party endorsements in a Posting; or (h) create a Posting that does not offer a Service.\n" +
...
"4. UR AVG SERVICEPROVIDER'S DISCLAIMERS AND RIGHT TO REMOVE\n" +
"1. Ur avg ServiceProvider does not endorse any Submitted Content or any opinion, recommendation, or advice expressed therein, and Ur avg ServiceProvider expressly disclaims any and all liability in connection with all Submitted Content. Ur avg ServiceProvider does not permit copyright infringing activities and infringement of intellectual property rights on the Website, and Ur avg ServiceProvider will remove any Data (as defined below) or Submitted Content if properly notified, pursuant to the “take down” notification procedure described in Section J below, that such Posting or Submitted Content infringes on another's intellectual property rights. Ur avg ServiceProvider reserves the right to remove any Data or Submitted Content without prior notice. Ur avg ServiceProvider will also terminate a user's access to the Website, if he or she is determined to be a repeat infringer. A repeat infringer is a Website user who has been notified of infringing activity more than twice and/ or has had Submitted Content removed from the Website more than twice. Ur avg ServiceProvider also reserves the right, in its sole and absolute discretion, to decide whether any Data or Submitted Content is appropriate and complies with these Terms of Use for all violations, in addition to copyright infringement and violations of intellectual property law, including, but not limited to, pornography, obscene or defamatory material, or excessive length. Ur avg ServiceProvider may remove such Submitted Content and/or terminate a user's access for uploading such material in violation of these Terms of Use at any time, without prior notice and in its sole discretion.\n" +
"2. You acknowledge and understand that when using the Website, you will be exposed to Submitted Content from a variety of sources, and that Ur avg ServiceProvider is not responsible for the accuracy, usefulness, safety, or intellectual property rights of or relating to such Submitted Content. You further acknowledge and understand that you may be exposed to Submitted Content that is inaccurate, offensive, indecent, or objectionable, and you agree to waive, and hereby do waive, any legal or equitable rights or remedies you have or may have against Ur avg ServiceProvider with respect thereto, and agree to indemnify and hold Ur avg ServiceProvider, its owners, members, managers, operators, directors, officers, agents, affiliates, and/or licensors, harmless to the fullest extent allowed by law regarding all matters related to your use of the Website.\n" +
"3. You are solely responsible for the photos, profiles and other content, including, without limitation, Submitted Content that you publish or display on or through the Website, or transmit to other Website users. You understand and agree that Ur avg ServiceProvider may, in its sole discretion and without incurring any liability, review and delete or remove any Submitted Content that violates this Agreement or which might be offensive, illegal, or that might violate the rights, harm, or threaten the safety of Website users or others.\n" +
"5. SUGGESTIONS.\n" +
"If you send or transmit any communications, comments, questions, suggestions, or related materials to Ur avg ServiceProvider, whether by letter, email, telephone, or otherwise (collectively, “Suggestions”), suggesting or recommending changes to the Website, including, without limitation, new features or functionality relating thereto, all such Suggestions are, and will be treated as, non-confidential and non-proprietary. You hereby assign all right, title, and interest in, and Ur avg ServiceProvider is free to use, without any attribution or compensation to you, any ideas, know-how, concepts, techniques, or other intellectual property and proprietary rights contained in the Suggestions, whether or not patentable, for any purpose whatsoever, including but not limited to, developing, manufacturing, having manufactured, licensing, marketing, and selling, directly or indirectly, products and services using such Suggestions. You understand and agree that Ur avg ServiceProvider is not obligated to use, display, reproduce, or distribute any such ideas, know-how, concepts, or techniques contained in the Suggestions, and you have no right to compel such use, display, reproduction, or distribution or seek recognition if the Suggestions are in fact implemented.\n" +
"J. Copyright Infringement Take Down Procedure\n" +
"Ur avg ServiceProvider has high regard for intellectual property and expects the same level of standard to be employed by its users. Ur avg ServiceProvider may, in appropriate circumstances and at its discretion, terminate the Account or prohibit access to the Website of users who infringe upon the intellectual property rights of others.\n" +
"If you believe that your work has been copied and posted on the Website in a way that constitutes copyright infringement and/or trademark infringement, please send the following information to us at help@Ur avg ServiceProvider.com\n" +
...
"(ii) identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled at the Website, and information reasonably sufficient to permit Ur avg ServiceProvider to locate the material.;\n" +
...
"(iv) information reasonably sufficient to permit Ur avg ServiceProvider to contact you as the complaining party, such as an address, telephone number, and, if available, an electronic mail address at which you may be contacted;\n" +
...
"Only the intellectual property rights owner is permitted to report potentially infringing items through Ur avg ServiceProvider's reporting system set forth above. If you are not the intellectual property rights owner, you should contact the intellectual property rights owner and they can choose whether to use the procedures set forth in these Terms of Use.\n" +
"K. Modifications to or Termination of Website\n" +
"1. MODIFICATION OR CESSATION OF WEBSITE\n" +
"Ur avg ServiceProvider reserves the right at any time and from time to time to modify or discontinue, temporarily or permanently, the Website (or any part thereof) with or without notice and in its sole discretion. You agree that Ur avg ServiceProvider shall not be liable to you or to any third party for any modification, suspension or discontinuance of Ur avg ServiceProvider services.\n" +
"2. TERMINATION BY UR AVG SERVICEPROVIDER\n" +
"You hereby acknowledge and agree that Ur avg ServiceProvider, in its sole and absolute discretion, has the right (but not the obligation) to delete, terminate, or deactivate your Account, block your email or IP address, cancel the Website or otherwise terminate your access to or participation in the use of the Website (or any part thereof), or remove and discard any Submitted Content on the Website (“Termination of Service”), immediately and without notice, for any reason, including without limitation, Account inactivity or if Ur avg ServiceProvider believes or has reason to believe that you have violated any provision of the Terms of Use.\n" +
...
"Upon termination of your Account, your right to participate in the Website, including, but not limited to, your right to offer or purchase Services and your right to receive any fees or compensation, including, without limitation, referral discounts, incentive bonuses, or other special offer rewards, shall automatically terminate. You acknowledge and agree that your right to receive any fees or compensation hereunder is conditional upon your proper use of the Website, your adherence to the Terms of Use, the continuous activation of your Account, and your permitted participation in the Website. In the event of Termination of Service, your Account will be disabled and you may not be granted access to your Account or any files or other data contained in your Account. Notwithstanding the foregoing, residual data may remain in the Ur avg ServiceProvider system.\n" +
"Unless Ur avg ServiceProvider has previously cancelled or terminated your use of the Website (in which case subsequent notice by Ur avg ServiceProvider shall not be required), if you provided a valid email address during registration, Ur avg ServiceProvider will notify you via email of any such termination or cancellation, which shall be effective immediately upon Ur avg ServiceProvider's delivery of such notice.\n" +
"Upon Termination of Service, the following shall occur: all licenses granted to you hereunder will immediately terminate; and you shall promptly destroy all copies of Ur avg ServiceProvider Data (as defined below), Marks (as defined below) and other content in your possession or control. You further acknowledge and agree that Ur avg ServiceProvider shall not be liable to you or any third party for any termination of your access to the Website. Upon Termination of Service, Ur avg ServiceProvider retains the right to use any data collected from your use of the Website for internal analysis and archival purposes, and all related licenses you have granted Ur avg ServiceProvider hereunder shall remain in effect for the foregoing purpose. In no event is Ur avg ServiceProvider obligated to return any Submitted Content to you. Sections K, L, M, N, O, Q, R, S, T, U, V, W, and X, shall survive expiration or termination of the Website or your Account.\n" +
"You agree to indemnify and hold Ur avg ServiceProvider, and its officers, managers, members, affiliates, successor, assigns, directors, agents, service professionals, suppliers, and employees harmless from any claim or demand, including reasonable attorneys' fees and court costs, made by any third party due to or arising out of the Termination of Service.\n" +
"L. Intellectual Property Rights\n" +
"1. UR AVG SERVICEPROVIDER OWNS OR HOLDS THE LICENSES TO ALL DATA AND MARKS ON THE WEBSITE\n" +
"The content on the Website (exclusive of all Submitted Content), including without limitation, the text, software, scripts, graphics, photos, sounds, music, videos, interactive features and the like (“Data”) and the trademarks, service marks and logos contained therein (“Marks”), are owned by Ur avg ServiceProvider. Other trademarks, names and logos on this Website are the property of their respective owners.\n" +
"Data on the Website is provided to you AS IS for your information and personal use only and may not be used, copied, reproduced, distributed, transmitted, broadcast, displayed, sold, licensed, or otherwise exploited for any other purposes whatsoever without the prior written consent of the respective owners. Ur avg ServiceProvider reserves all rights not expressly granted in and to the Website and the Data. You agree not to use, copy, or distribute, any of the Data other than as expressly permitted herein, including any use, copying, or distribution of Submitted Content obtained through the Website for any commercial purposes. If you download or print a copy of the Data for personal use, you must retain all copyright and other proprietary notices contained thereon. You agree not to circumvent, disable or otherwise interfere with security features of the Website or features that prevent or restrict use or copying of any Data or enforce limitations on use of the Website or the Data therein.\n" +
"2. UR AVG SERVICEPROVIDER'S LICENSE TO YOU FOR THE USE OF DATA AND MARKS\n" +
"The Website contains Ur avg ServiceProvider's Data and Marks, which are, or may become, protected by copyright, trademark, patent, trade secret and other laws, and Ur avg ServiceProvider owns and retains all rights in the Ur avg ServiceProvider Data and Marks. Subject to these Terms of Use, Ur avg ServiceProvider hereby grants you a limited, revocable, nontransferable, nonsublicensable license to reproduce and display the Ur avg ServiceProvider Data (excluding any software source code) solely for your personal use in connection with accessing and participating in the Website.\n" +
...
"In the event, (i) the job lead is identified to be non-genuine, or (ii) the Service User within 48 hours of posting a request on the Website withdraws the same by way of the Website or the mobile application only, or (iii) the Service Professional pays the Lead Fee to respond to the Service User’s request for service but the Service User does not open or access the Service Professional’s response, the Lead Fee shall be reimbursed to the Service Professional. The decision of Ur avg ServiceProvider pertaining to the above shall be final and binding.\n" +
"Ur avg ServiceProvider offers premium services to Service Professionals for a fee and may in the future offer additional services, like tax preparation and bookkeeping that Service Professionals can also choose to purchase. Ur avg ServiceProvider reserves the right to charge fees for these services at its sole discretion.\n" +
"2. FEES INCURRED BY SERVICE USERS\n" +
"Joining Ur avg ServiceProvider, opening an Account, viewing posted Services, and bidding on posted Services is free. Ur avg ServiceProvider currently does not charge Service Users for transactions completed on the Website between Service Users and Services Professionals. However, Ur avg ServiceProvider reserves the right to charge a fee to Service Users in the future on a per-transaction basis or in any other manner, and reserves the right to do so in its sole discretion. Changes to this Fee Policy are effective after Ur avg ServiceProvider has provided you with thirty (30) days' notice by posting the changes on the Website.\n" +
"If applicable, you agree to pay all fees or charges to your Account based on Ur avg ServiceProvider's fees, charges, and billing terms then in effect. If you do not pay on time or if Ur avg ServiceProvider cannot charge your credit card, any payment gateway or other payment method for any reason, Ur avg ServiceProvider reserves the right to either suspend or terminate your access to the Website and Account and terminate these Terms of Use. You are expressly agreeing that Ur avg ServiceProvider is permitted to bill you for the applicable fees, any applicable tax and any other charges you may incur in connection with your use of this Website and the fees will be billed to your credit card, a payment gateway or other payment method designated at the time you make a purchase or register for a fee-based service. If you cancel your Account at any time, you will not receive any refund. If you have a balance due on any account, you agree that Ur avg ServiceProvider may charge such unpaid fees to your credit card or otherwise bill you for such unpaid fees. Ur avg ServiceProvider reserves its right to initiate appropriate legal proceedings, if necessary, in its sole discretion, to recover such outstanding amounts.\n" +
"3. TAXES\n" +
"You understand that we are acting solely as an intermediary for the collection of rents and fees between a Service User and a Service Professional who choose to enter into an Agreement for Service. Because state and local tax laws vary significantly by locality, you understand and agree that you are solely responsible for determining your own tax reporting requirements in consultation with tax advisors, and that we cannot and do not offer tax advice to either hosts or guests. Further, you understand that Ur avg ServiceProvider shall not be responsible or liable in any manner in relation to tax liability of a Service User or a Service Professional.\n" +
"4. REFUND POLICY\n" +
"All commissions payable to Ur avg ServiceProvider by Service Professionals on consummated transactions, i.e. exchange of services for consideration, are final and non-refundable.\n" +
"All monies paid by Service Professionals in form of “Credits” are non-interest bearing. Unutilised and unclaimed “Credits” for a period of more than 364 days from the date of purchase of “Credits” shall expire and stand forfeited. No refunds of credits will be processed after the expiry date.\n" +
"N. Negotiation of Terms of Service; Disputes Between Registered Users\n" +
"1. NEGOTIATION WORKSHEET AND CONTRACT TEMPLATE\n" +
"As a courtesy to Registered Users, to facilitate the negotiation and confirmation of the Agreement for Service, Ur avg ServiceProvider provides a general framework for negotiating the terms of Service (e.g., rate) (“Negotiation Worksheet”). Registered Users acknowledge and agree that (i) they are solely responsible for addressing all issues that exist now or may arise in the future in connection with the applicable Service; and (ii) it is solely up to such Registered Users, if they so desire, to enter into a signed, written contract, that addresses all of the relevant issues and memorializes the agreed upon Negotiation Worksheet.\n" +
"You should not rely on the any information or resources contained on the Website, including, without limitation, the Negotiation Worksheet, as a replacement or substitute for any professional, financial, legal or other advice or counsel. Ur avg ServiceProvider makes no representations and warranties, and expressly disclaims any and all liability, concerning actions taken by a user following the information or using the resources offered or provided on or through the Websites, including, without limitation, the Negotiation Worksheet. In no way will Ur avg ServiceProvider be responsible for any actions taken or not taken based on the information or resources provided on this Website. If you have a situation that requires professional advice, you should consult a qualified specialist. Do not disregard, avoid or delay obtaining professional advice from a qualified specialist because of information or resources that are provided on this Website, however provided.\n" +
"2. UR AVG SERVICEPROVIDER IS NOT A PARTY TO ANY SERVICE CONTRACT\n" +
"Each Registered User hereby acknowledges and agrees that Ur avg ServiceProvider is NOT a party to any oral or written Agreement for Service, Negotiation Worksheet, or any contract entered into between Registered Users in connection with any Service offered, directly or indirectly, through the Website. Each Registered User acknowledges, agrees and understands that Ur avg ServiceProvider only seeks to provide a platform wherein the Service User and Service Professional can be brought together and Ur avg ServiceProvider itself has not role in the execution or provision of Services.\n" +
"3. NO AGENCY OR PARTNERSHIP\n" +
"No agency, partnership, joint venture, or employment is created as a result of the Terms of Use or your use of any part of the Website, including without limitation, the Negotiation Worksheet or Agreement for Service. You do not have any authority whatsoever to bind Ur avg ServiceProvider in any respect. All Service Professionals are independent contractors. Neither Ur avg ServiceProvider nor any users of the Website may direct or control the day-to-day activities of the other, or create or assume any obligation on behalf of the other.\n" +
...
"You understand that deciding whether to use the Services of a Service Professional or provide Services to a Service User or use information contained in any Submitted Content, including, without limitation, Postings, Offers, Wants and/or Feedback, is your personal decision for which alone are responsible. You understand that Ur avg ServiceProvider does not warrant and cannot make representations as to the suitability of any individual you may decide to interact with on or through the Website and/or the accuracy or suitability of any advice, information, or recommendations made by any individual. While Ur avg ServiceProvider may attempt to seek information about the background of a Service Professional, either via a telephonic or in-person interview, review of past work/customer feedback and/or check presence online (if available) on Facebook, personalised website, LinkedIn, Twitter etc., you understand that Service Professionals may register themselves suo moto. You also understand that any so called background check undertaken by Ur avg ServiceProvider is not exhaustive to the extent to determine previous criminal antecedents and hence, at the end of the day, the Service User should take an informed decision on his/her own accord and keep in mind the fact that Ur avg ServiceProvider only seeks to provide a platform wherein Service Users and Service Professionals have an opportunity to meet each other.\n" +
"NOTWITHSTANDING THE FOREGOING, YOU AGREE THAT SINCE UR AVG SERVICEPROVIDER only seeks to provide a platform wherein the Service User and Service Professional can be brought together and Ur avg ServiceProvider itself has not role in the execution or provision of Services ITSELF, URBAN CLAP SHALL NOT BE RESPONSIBLE OR LIABLE FOR ANY LOSS OR DAMAGE OF ANY SORT WHATSOEVER INCURRED AS THE RESULT OF ANY SUCH TRANSACTION OR DEALINGS. IF THERE IS A DISPUTE BETWEEN PARTICIPANTS ON THE WEBSITE, OR BETWEEN REGISTERED USERS OR ANY WEBSITE USER AND ANY THIRD PARTY, YOU ACKNOWLEDGE AND AGREE THAT UR AVG SERVICEPROVIDER IS UNDER NO OBLIGATION TO BECOME INVOLVED. IN THE EVENT THAT A DISPUTE ARISES BETWEEN YOU AND ONE OR MORE WEBSITE USERS, REGISTERED USERS OR ANY THIRD PARTY, YOU HEREBY RELEASE UR AVG SERVICEPROVIDER, ITS OFFICERS, MANAGERS, MEMBERS, DIRECTORS, EMPLOYEES, ATTORNEYS, AGENTS, AND SUCCESSORS IN RIGHTS FROM ANY CLAIMS, DEMANDS, AND DAMAGES (ACTUAL AND CONSEQUENTIAL) OF EVERY KIND OR NATURE, KNOWN OR UNKNOWN, SUSPECTED OR UNSUSPECTED, FORESEEABLE OR UNFORESEEABLE, DISCLOSED OR UNDISCLOSED, ARISING OUT OF OR IN ANY WAY RELATED TO SUCH DISPUTES AND/OR THE WEBSITE OR ANY SERVICE PROVIDED THEREUNDER.\n" +
"O. Dispute Resolution\n" +
"If a dispute arises between you and Ur avg ServiceProvider, our goal is to provide you with a neutral and cost effective means of resolving the dispute quickly. Accordingly, you and Ur avg ServiceProvider hereby agree that we will resolve any claim or controversy at law and equity that arises out of the Terms of Use or the Website in accordance with this Section O or as we and you otherwise agree in writing. Before resorting to the filing of a formal lawsuit, we strongly encourage you to first contact us directly to seek a resolution via e-mail at support@Ur avg ServiceProvider.com. The dispute shall be resolved through alternative dispute resolution procedures, such as mediation or arbitration, as alternatives to litigation.\n" +
"1. GOVERNING LAW\n" +
...
"P. Advertisements\n" +
"Aspects of the Website and other Ur avg ServiceProvider services may be supported by advertising revenue. As such, Ur avg ServiceProvider may display advertisements and promotions on the service. The manner, mode and extent of advertising by Ur avg ServiceProvider on the Website are subject to change and the appearance of advertisements on the Website does not necessarily imply endorsement by Ur avg ServiceProvider of any advertised products or services. You agree that Ur avg ServiceProvider shall not be responsible or liable for any loss or damage of any sort incurred by you as a result of any such dealings or as the result of the presence of such advertisers on the Website.\n" +
"Q. Third-party Links, Contact Forms and Phone Numbers\n" +
"The Website may provide, or third parties may provide, links, contact forms and/or phone numbers to other websites or resources, including, without limitation, social networking, blogging and similar websites through which you are able to log into the Website using your existing account and log-in credentials for such third-party websites. Certain areas of the Website may allow you to interact and/or conduct transactions with such third-party sites, and, if applicable, allow you to configure your privacy settings in your third-party site account to permit your activities on the Website to be shared with your contacts in your third-party site account. Because Ur avg ServiceProvider has no control over such sites and resources, you acknowledge and agree that Ur avg ServiceProvider is not responsible for the availability of such external sites or resources, and is not responsible or liable for any content, advertising, products, goods or services on or available from such websites or resources. Unless expressly stated on the Website, links to third-party sites should in no way be considered as or interpreted to be Ur avg ServiceProvider's endorsement of such third-party sites or any product or service offered through them. You further acknowledge and agree that Ur avg ServiceProvider shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, advertising, product, goods or services available on or through any such website or resource. The Third-party website may have different privacy policies and terms and conditions and business practices than Ur avg ServiceProvider. In certain situations, you may be transferred to a Third-party website through a link or connected to a Third-party resource by a contact form or phone but it may appear that you are still on this Website or transacting with Ur avg ServiceProvider. In these situations, you acknowledge and agree that the Third-party website terms and conditions and privacy policy apply in this situation. Your dealings and communications through the Website with any party other than Ur avg ServiceProvider are solely between you and such third party. Any complaints, concerns or questions you have relating to materials provided by third parties should be forwarded directly to the applicable third party.\n" +
"R. Disclaimer of Warranties\n" +
"YOU AGREE THAT YOUR USE OF THE WEBSITE SHALL BE AT YOUR OWN RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, AND UR AVG SERVICEPROVIDER AND ITS OFFICERS, MANAGERS, MEMBERS, DIRECTORS, EMPLOYEES, SUCCESSORS, ASSIGNS, SUBSIDIARIES, AFFILIATES, SERVICE PROFESSIONALS, SUPPLIERS, AND AGENTS DISCLAIM ALL WARRANTIES, EXPRESS, IMPLIED, STATUTORY OR OTHERWISE, AND MAKE NO WARRANTIES, REPRESENTATIONS, OR GUARANTEES IN CONNECTION WITH THIS WEBSITE, THE SERVICES OFFERED ON OR THROUGH THIS WEBSITE, ANY DATA, MATERIALS, SUBMITTED CONTENT, RELATING TO THE QUALITY, SUITABILITY, TRUTH, ACCURACY OR COMPLETENESS OF ANY INFORMATION OR MATERIAL CONTAINED OR PRESENTED ON THIS WEBSITE, INCLUDING WITHOUT LIMITATION THE MATERIALS, DATA AND SUBMITTED CONTENT OF OTHER USERS OF THIS SITE OR OTHER THIRD PARTIES. UNLESS OTHERWISE EXPLICITLY STATED, TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THIS WEBSITE, THE SERVICES OFFERED ON OR THROUGH THIS WEBSITE, DATA, MATERIALS, SUBMITTED CONTENT, AND ANY INFORMATION OR MATERIAL CONTAINED OR PRESENTED ON THIS WEBSITE IS PROVIDED TO YOU ON AN “AS IS,” “AS AVAILABLE” AND “WHEREIS” BASIS WITH NO WARRANTY OF IMPLIED WARRANTY OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT OF THIRD-PARTY RIGHTS. UR AVG SERVICEPROVIDER DOES NOT PROVIDE ANY WARRANTIES AGAINST ERRORS, MISTAKES, OR INACCURACIES OF DATA, CONTENT, INFORMATION, MATERIALS, SUBSTANCE OF THE WEBSITE OR SUBMITTED CONTENT, ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE WEBSITE BY ANY THIRD PARTY, ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE WEBSITE, ANY DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY OR SERVICE USER OR SERVICE PROVIDER, OR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY DATA, CONTENT, INFORMATION, MATERIALS, SUBSTANCE OF THE WEBSITE OR SUBMITTED CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE WEBSITE. UR AVG SERVICEPROVIDER DOES NOT ENDORSE, WARRANT, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE WEBSITE OR ANY HYPERLINKED SITE OR FEATURED IN ANY BANNER OR OTHER ADVERTISEMENT. UR AVG SERVICEPROVIDER WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY PARTY, INCLUDING THIRD PARTY SERVICE PROFESSIONALS OF PRODUCTS OR SERVICES. AS WITH THE USE OF ANY PRODUCT OR SERVICE, AND THE PUBLISHING OR POSTING OF ANY MATERIAL THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.\n");
 jTextArea1.append("\"S. Limitations of Liability\\n\" +\n" +
"\"1. IN NO EVENT SHALL UR AVG SERVICEPROVIDER, OR ITS RESPECTIVE OFFICERS, MANAGERS, MEMBERS, DIRECTORS, EMPLOYEES, SUCCESSORS, ASSIGNS, SUBSIDIARIES, AFFILIATES, SERVICE PROFESSIONALS, SUPPLIERS, ATTORNEYS OR AGENTS, BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, CONSEQUENTIAL OR EXEMPLARY DAMAGES (INCLUDING BUT NOT LIMITED TO LOSS OF BUSINESS, REVENUE, PROFITS, USE, DATA OR OTHER ECONOMIC ADVANTAGE) WHATSOEVER RESULTING FROM ANY (I) ACCESS TO OR USE OF THE WEBSITE OR ANY SERVICES OFFERED BY ANY SERVICE PROFESSIONALS VIA THE WEBSITE, INCLUDING SERVICES PROVIDED PURSUANT TO AN AGREEMENT FORMED INDEPENDENTLY OF THE WEBSITE, WHETHER OR NOT AN AGREEMENT FOR SERVICE FORMED VIA THE WEBSITE IS IN EFFECT; (II) ERRORS, MISTAKES, OR INACCURACIES OF DATA, MARKS, CONTENT, INFORMATION, MATERIALS OR SUBSTANCE OF THE WEBSITE OR SUBMITTED CONTENT; (III) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN; (IV) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE WEBSITE BY ANY THIRD PARTY; (V) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE WEBSITE; (VI) ANY ERRORS OR OMISSIONS IN ANY DATA, CONTENT, INFORMATION, MATERIALS OR SUBSTANCE OF THE WEBSITE OR SUBMITTED CONTENT; (VII) ANY FAILED NEGOTIATIONS FOR A SERVICE, ANY DISPUTES THAT ARISE DURING OR AFTER THE NEGOTIATION OF A SERVICE OR THE FORMATION OF A CONTRACT FOR A SERVICE, OR ANY OTHER DISPUTE THAT ARISES BETWEEN USERS OF THE WEBSITE; (VIII) ANY DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY OR SERVICE USER OR SERVICE PROFESSIONAL; OR (IX) ANY USE OF ANY DATA, MARKS, CONTENT, INFORMATION, MATERIALS OR SUBSTANCE OF THE WEBSITE OR SUBMITTED CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE ON OR THROUGH THE WEBSITE, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT UR AVG SERVICEPROVIDER IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW IN THE APPLICABLE JURISDICTION.\\n\" +\n" +
"\"2. IN NO EVENT SHALL THE TOTAL, AGGREGATE LIABILITY OF UR AVG SERVICEPROVIDER, OR ANY OF THE ABOVE-REFERENCED RESPECTIVE PARTIES, ARISING FROM OR RELATING TO THE WEBSITE, AND/OR SUBMITTED CONTENT EXCEED THE TOTAL AMOUNT OF FEES ACTUALLY PAID TO UR AVG SERVICEPROVIDER BY YOU HEREUNDER.\\n\" +\n" +
"\"YOU HEREBY ACKNOWLEDGE AND AGREE THAT UR AVG SERVICEPROVIDER SHALL NOT BE LIABLE FOR SUBMITTED CONTENT OR THE DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY OR SERVICE USER OR SERVICE PROVIDER AND THAT THE RISK OF HARM OR DAMAGE FROM THE FOREGOING RESTS ENTIRELY WITH YOU. YOU FURTHER ACKNOWLEDGE AND AGREE THAT UR AVG SERVICEPROVIDER SHALL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, CONSEQUENTIAL OR EXEMPLARY DAMAGES (INCLUDING BUT NOT LIMITED TO LOSS OF BUSINESS, REVENUE, PROFITS, USE, DATA OR OTHER ECONOMIC ADVANTAGE) WHATSOEVER RESULTING FROM OR RELATING TO ANY CONTRACT BETWEEN WEBSITE USERS ENTERED INTO INDEPENDENTLY OF THE WEBSITE.\\n\" +\n" +
"\"THE WEBSITE MAY CONTAIN LINKS TO THIRD-PARTY WEBSITES THAT ARE NOT OWNED OR CONTROLLED BY UR AVG SERVICEPROVIDER. UR AVG SERVICEPROVIDER DOES NOT HAVE ANY CONTROL OVER, AND ASSUMES NO RESPONSIBILITY FOR, THE CONTENT, PRIVACY POLICIES, OR PRACTICES OF ANY THIRD-PARTY WEBSITES. IN ADDITION, UR AVG SERVICEPROVIDER WILL NOT AND CANNOT CENSOR OR EDIT THE CONTENT OF ANY THIRD-PARTY SITE. BY USING THE WEBSITE, YOU EXPRESSLY RELIEVE UR AVG SERVICEPROVIDER FROM ANY AND ALL LIABILITY ARISING FROM YOUR USE OF ANY THIRDPARTY WEBSITE. ACCORDINGLY, PLEASE BE ADVISED TO READ THE TERMS AND CONDITIONS AND PRIVACY POLICY OF EACH THIRD-PARTY WEBSITE THAT YOU VISIT, INCLUDING THOSE DIRECTED BY THE LINKS CONTAINED ON THE WEBSITE.\\n\" +\n" +
"\"3. FORCE MAJEURE\\n\" +\n" +
"\"Neither Ur avg ServiceProvider nor you shall be liable to the other for any delay or failure in performance under the Terms of Use, other than payment obligations, arising out of a cause beyond its control and without its fault or negligence. Such causes may include, but are not limited to fires, floods, earthquakes, strikes, unavailability of necessary utilities, blackouts, acts of God, acts of declared or undeclared war, acts of regulatory agencies, or national disasters.\\n\" +\n" +
"\"T. Indemnification and Release\\n\" +\n" +
"\"YOU AGREE TO DEFEND, INDEMNIFY AND HOLD HARMLESS UR AVG SERVICEPROVIDER, AND ITS OFFICERS, MANAGERS, MEMBERS, DIRECTORS, EMPLOYEES, SUCCESSORS, ASSIGNS, SUBSIDIARIES, AFFILIATES, SERVICE PROFESSIONALS, SUPPLIERS, AND AGENTS, FROM AND AGAINST ANY AND ALL CLAIMS, DAMAGES, OBLIGATIONS, LOSSES, LIABILITIES, COSTS OR DEBT, AND EXPENSES (INCLUDING BUT NOT LIMITED TO ATTORNEYS' FEES) ARISING FROM YOUR USE OF, ACCESS TO, AND PARTICIPATION IN THE WEBSITE; YOUR VIOLATION OF ANY PROVISION OF THE TERMS OF USE, INCLUDING THE PRIVACY POLICY; YOUR VIOLATION OF ANY THIRD-PARTY RIGHT, INCLUDING WITHOUT LIMITATION ANY COPYRIGHT, PROPERTY, PROPRIETARY, INTELLECTUAL PROPERTY, OR PRIVACY RIGHT; OR ANY CLAIM THAT YOUR SUBMITTED CONTENT CAUSED DAMAGE TO A THIRD PARTY. THIS DEFENSE AND INDEMNIFICATION OBLIGATION WILL SURVIVE THESE TERMS OF SERVICE AND YOUR USE OF THE WEBSITE.\\n\" +\n" +
"\"IF YOU HAVE A DISPUTE WITH ONE OR MORE WEBSITE USERS, YOU FOREVER RELEASE UR AVG SERVICEPROVIDER (AND ITS OFFICERS, MANAGERS, MEMBERS, DIRECTORS, EMPLOYEES, SUCCESSORS, ASSIGNS, SUBSIDIARIES, AFFILIATES, SERVICE PROFESSIONALS, SUPPLIERS, AGENTS, SUBSIDIARIES, AND EMPLOYEES) FROM ANY AND ALL CLAIMS, DEMANDS AND DAMAGES (ACTUAL AND CONSEQUENTIAL) OF EVERY KIND AND NATURE, KNOWN AND UNKNOWN, ARISING OUT OF OR IN ANY WAY CONNECTED WITH YOUR USE OF THE WEBSITE AND/OR ANY SUBMITTED CONTENT.\\n\" +\n" +
"\"THE TERMS OF USE, AND ANY RIGHTS AND LICENSES GRANTED HEREUNDER, MAY NOT BE TRANSFERRED OR ASSIGNED BY YOU, BUT MAY BE ASSIGNED BY UR AVG SERVICEPROVIDER WITHOUT RESTRICTION.\\n\" +\n" +
...
"\"V. Notice\\n\" +\n" +
"\"You agree that Ur avg ServiceProvider may provide you with notices, including those regarding changes to the Terms of Use, by email, regular mail, or postings on the Website.\\n\" +\n" +
"\"W. General Information\\n\" +\n" +
"\"1. ENTIRE TERMS OF USE\\n\" +\n" +
"\"The Terms of Use, together with the Privacy Policy and any other legal notices or Additional Policies published by Ur avg ServiceProvider on the Website, shall constitute the entire agreement between you and Ur avg ServiceProvider concerning the Website. If any provision of the Terms of Use is deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of the Terms of Use, which shall remain in full force and effect.\\n\" +\n" +
"\"No waiver of any provision of this these Terms of Use shall be deemed a further or continuing waiver of such term or any other term, and Ur avg ServiceProvider's failure to assert any right or provision under these Terms of Use shall not constitute a waiver of such right or provision.\\n\" +\n" +
...
"\"© 2018 Ur avg ServiceProvider India Technology Private Limited. All Rights Reserved\"");
